...
use crate::{
    state::{Objective,ObjectiveState,ObjectiveDeliverable},
};
...
pub fn handler(ctx: Context<AddObjective>, objective_title: String,objective_start_unix:u64,objective_end_unix:u64,objective_description_link:String,objective_state:ObjectiveState,objective_deliverable:ObjectiveDeliverable) -> Result<()> {
    ...
    metadata_account.objective_title = objective_title;
    ...
    metadata_account.objective_description_link = objective_description_link;
